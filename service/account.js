  ...
  identity: function(req, res, next){
    ...
    workflow.on('patchUser', function() {
      var fieldsToSet = {
        ...
        atlantic:  			req.body.atlantic,
        hunterdon:  		req.body.hunterdon,
        sussex:  			req.body.sussex,
        gloucester:  		req.body.gloucester,
        salem:  			req.body.salem,
        cumberland:  		req.body.cumberland,
        ocean:  			req.body.ocean,
        camden:  			req.body.camden,
        monmouth:  			req.body.monmouth,
        bergen:  			req.body.bergen,
        merser:  			req.body.merser,
        union:  			req.body.union,
        hudson:  			req.body.hudson,
        somerset:  			req.body.somerset,
        essex:  			req.body.essex,
        passaic:  			req.body.passaic,
        capemay:  			req.body.capemay,
        morris:  			req.body.morris,
        burlington:  		req.body.burlington,
